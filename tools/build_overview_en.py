...
<div class="notice" style="margin:0 0 3rem">
  <strong>Preparation materials.</strong> This test comes with a free <a href="course/amc10/index-en.html">ten-week crash course</a>: self-contained, run by a parent with no teacher needed &mdash; theory, worked examples, independent sets with solutions, tests, and printable PDFs.
</div>

<footer>
  All problems on this page are original and do not reproduce official AMC competition problems. Official past tests and rules &mdash; at <a href="https://maa.org/student-programs/amc/">maa.org</a>. Next: <a href="course/amc10/index-en.html">the ten-week crash course</a>.
</footer>
